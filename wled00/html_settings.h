...
Strip or panel: <select id="somp" name="SOMP" onchange="MPDiv()"><option 
value="0" selected="selected">1D Strip</option><option value="1">2D Matrix panel
</option></select><br><div id="mpdiv"><h3>2D Matrix</h3>Width <input id="mxw" 
name="MXW" type="number" min="1" max="1500" oninput="UI()"> x Height <input 
id="mxh" name="MXH" type="number" min="1" max="1500" oninput="UI()"><br><div 
