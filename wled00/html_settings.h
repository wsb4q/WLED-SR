...
var d=document;function H(){window.open("https://github.com/atuline/WLED/wiki/Squelch-and-Gain")}function B(){window.open("/settings","_self")}function S(){GetV(),enDM()}function enDM(){var n=parseInt(d.getElementById("dme").value);console.log(n),d.getElementById("dm").style.display=1==n?"inline":"none",d.getElementById("am").style.display=0==n?"inline":"none"}function GetV() {var d=document;
%CSS%%SCSS%</head><body onload="S()"><form
 id="form_s" name="Sf" method="post"><div class="helpB"><button type="button" 
onclick="H()">?</button></div><button type="button" onclick="B()">Back</button>
...
selected="selected">Analog</option><option value="1">Digital</option></select>
<br><div id="dm">I2S SD pin: <input type="number" min="-1" max="40" name="DI">
<br>I2S WS pin: <input type="number" min="-1" max="40" name="LR"><br>
