...
body{text-align:center;background:#222;height:100px;margin:0}html{--h:10.45vh}button{background:#333;color:#fff;font-family:Verdana,Helvetica,sans-serif;border:.3ch solid #333;border-radius:.5em;display:inline-block;font-size:7.75vmin;line-height:1em;height:var(--h);width:95%%;margin-top:2vh}
</style><script>
...
<div id="mxphv">Horizontal panels: <input name="MXPH" type="number" min="1" 
max="8" oninput="UI()"> Vertical panels: <input name="MXPV" type="number" 
